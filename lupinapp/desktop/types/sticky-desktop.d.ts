...
export type ShortcutCommand =
  ...
  | { type: "open-previous-episode" }
  | { type: "open-next-episode" }
  | { type: "open-episode-list" }
  | { type: "open-episode-comments" }
  | { type: "open-site-recent" }
  | { type: "toggle-reader-devtools" };
...
export interface StickyDesktopApi {
  ...
  toggleReaderDevTools(): Promise<boolean>;
